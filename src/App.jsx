...
import { BsEmojiAngry, BsEmojiAstonished, BsEmojiNeutral, BsEmojiSmile, BsEmojiWink } from 'react-icons/bs';
    ...
    <div className="emoji-selector">
      {emojis.map((emoji, index) => (
        <span
          ...
          style={{
            cursor: 'pointer',
            backgroundColor: hoveredIndex === index ? emoji.hoverColor : (value === index + 1 ? emoji.hoverColor : 'inherit'),
            fontSize: '2rem',
            marginRight: '0.5rem',
            padding: '0.5rem',
            borderRadius: '50%',
...
const App = () => {
  ...
  useEffect(() => {
    const storedRecords = JSON.parse(localStorage.getItem('registrationFeedback') || '[]');
  ...
  const handleSubmit = (event) => {
    ...
    if (editIndex !== null) {
      ...
      localStorage.setItem('registrationFeedback', JSON.stringify(updatedRecords));
      setEditIndex(null);
    } else {
        ...
        <Col md={5}>
          ...
          <Form onSubmit={handleSubmit} className='fw-bold'>
            ...
            <Form.Group controlId="source" className='my-3'>
              ...
              <Form.Select name="source" value={formData.source} onChange={handleChange} aria-label="Source select">
            ...
            <fieldset>
              <Form.Group>
                ...
                <Row>
                  <Col md={6}>
                    <Form.Label className='my-3'>Registration Process</Form.Label>
                    <EmojiSelector
                      emojis={emojis}
            ...
            <Button variant="primary" className='fw-bold' type="submit">{editIndex !== null ? 'Update Feedback' : 'Submit Feedback'}</Button>
            {editIndex !== null && <Button variant="secondary" onClick={() => setEditIndex(null)} className="ml-2">Cancel</Button>}
          </Form>
        </Col>
        <Col md={7}>
